...
// cuantos dias se usa cada habitacion (simple, blablabla)
export const usoDiario = async (inicio, fin) => {
    const [resultado] = await db.query(`
        ...
        FROM (
            ...
            FROM seq_0_to_1000 -- generador de días (puedes usar otra técnica)
...
//esto devuelve ingresos por dia
export const ingresosPorDia = async (inicio, fin) => {
    const [resultado] = await db.query(`
...
//esto devuelve ingresos por mes
