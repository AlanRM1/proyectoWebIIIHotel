...
const insertaReserva = async (reserva) => {
    ...
    const [habitacionData] = await db.query(
        `SELECT precio_base FROM habitaciones WHERE id = ?`,
        [habitacion_id]
    );
...
const actualizaReserva = async (id, datos) => {
